...
public class GCard extends GCompound implements Card, Cell {
	...
	public GCard(GCard c) {
		this(c.getRank(), c.getSuit());
	}
	
	public Cell copy() {
		return new GCard(rank, suit);
	}
	...
	public boolean equals(Cell c) {
		return suit == ((GCard)c).getSuit() && rank == ((GCard)c).getRank();
	}
}
